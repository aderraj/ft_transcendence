...
this project is not completed and I have a deadline very soon , take the old source code build on it to achive this 
...
└── common/         # chat using websockets , ping pong trick to check if the user online or not
```
...
- check the friend status before sending message , you can't send message to someone you are not friend with
