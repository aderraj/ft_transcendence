                ...
                {success ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <label htmlFor="reset-pass" className="text-xs font-bold text-cyan-400 uppercase ml-1">New Password</label>
                            <input 
                                id="reset-pass"
                                name="newPassword"
                                ...
                                className="w-full bg-black/40 border border-white/10 rounded-xl py-3 px-4 text-white focus:border-cyan-400/50 focus:outline-none" 
                                placeholder="Min 6 characters"
                            />
                        </div>
                        <div className="space-y-2">
                            <label htmlFor="reset-confirm" className="text-xs font-bold text-cyan-400 uppercase ml-1">Confirm Password</label>
                            <input 
                                id="reset-confirm"
                        ...
                        <button type="submit" disabled={loading} className="w-full py-3 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-black italic uppercase text-xs tracking-widest hover:from-cyan-500 hover:to-blue-500 transition-all shadow-[0_0_15px_rgba(6,182,212,0.3)] disabled:opacity-50">
  ...
  return (
    <div className="w-full max-w-md relative">
      ...
      <div className={`p-8 rounded-3xl bg-cyan-950/40 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.5)] transition-all ${showResetModal ? 'blur-sm opacity-50 pointer-events-none' : ''}`}>
        ...
        <h2 className="text-3xl font-black italic text-center text-white tracking-widest uppercase drop-shadow-[0_0_15px_rgba(34,211,238,0.6)] mb-2">
          {view === 'login' ? 'Identity Verification' : view === 'register' ? 'New Identity' : view === '2fa' ? 'Second Factor' : 'Recovery Mode'}
        </h2>
        <p className="text-center text-cyan-200/50 text-xs tracking-wider mb-8">
          {view === 'login' ? 'RESTRICTED ACCESS' : view === 'register' ? 'INITIALIZE NEW USER PROTOCOL' : view === '2fa' ? 'ENTER SECURITY CODE' : 'INITIATE CREDENTIAL RESET'}
        </p>
          ...
          <div className="animate-in fade-in slide-in-from-left-4 duration-300">
            <form onSubmit={handleLoginSubmit} className="space-y-6">
              ...
              <div className="group space-y-2">
                <label htmlFor="login-username" className="text-xs font-semibold text-cyan-300/70 uppercase tracking-wider ml-1">Username</label>
              ...
              <div className="group space-y-2">
                <label htmlFor="login-password" className="text-xs font-semibold text-cyan-300/70 uppercase tracking-wider ml-1">Password</label>
                <div className="relative">
              ...
              <button type="submit" disabled={isLoading} className="w-full mt-8 py-3.5 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-black italic uppercase tracking-widest hover:from-cyan-500 hover:to-blue-500 disabled:opacity-50">
          ...
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            <form onSubmit={handleRegisterSubmit} className="space-y-4">
                <div className="group space-y-1">
                    <label htmlFor="reg-email" className="text-xs font-semibold text-cyan-300/70 uppercase tracking-wider ml-1">Email</label>
                    <div className="relative">
                        ...
                        <input 
                            ...
                            onChange={e => {setRegisterData({...registerData, email: e.target.value}); clearFieldError('email');}} 
                ...
                <div className="group space-y-1">
                    <label htmlFor="reg-username" className="text-xs font-semibold text-cyan-300/70 uppercase tracking-wider ml-1">Username</label>
                    <div className="relative">
                        ...
                        <input 
                            ...
                            onChange={e => {setRegisterData({...registerData, username: e.target.value}); clearFieldError('username');}} 
                ...
                <div className="group space-y-1">
                    <label htmlFor="reg-display" className="text-xs font-semibold text-cyan-300/70 uppercase tracking-wider ml-1">Display Name</label>
                    <div className="relative">
                        ...
                        <input 
                            ...
                            onChange={e => {setRegisterData({...registerData, displayName: e.target.value}); clearFieldError('displayName');}} 
                ...
                <div className="group space-y-1">
                    <label htmlFor="reg-pass" className="text-xs font-semibold text-cyan-300/70 uppercase tracking-wider ml-1">Password</label>
                    <div className="relative">
                ...
                <div className="group space-y-1">
                    <label htmlFor="reg-confirm" className="text-xs font-semibold text-cyan-300/70 uppercase tracking-wider ml-1">Confirm Password</label>
                    <div className="relative">
                ...
                <button type="submit" disabled={isLoading} className="w-full mt-6 py-3.5 rounded-xl font-black italic tracking-widest uppercase transition-all duration-300 bg-gradient-to-r from-emerald-600 to-cyan-600 text-white hover:from-emerald-500 hover:to-cyan-500 hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] disabled:opacity-50 disabled:cursor-not-allowed border border-white/10">
        ...
        {view === 'forgot' && (
           <form onSubmit={handleResetRequestSubmit} className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              <div className="group space-y-2">
                  <label htmlFor="forgot-email" className="text-xs font-semibold text-cyan-300/70 uppercase tracking-wider ml-1">Recovery Email</label>
                  <div className="relative">
                    ...
                    <input 
                        ...
                        className={getInputClass('resetEmail')} 
              ...
              <div className="flex gap-4 pt-2">
                  ...
                  <button type="submit" disabled={isLoading} className="flex-[2] py-3 bg-cyan-600 text-white rounded-xl text-xs font-black italic uppercase hover:bg-cyan-500 disabled:opacity-50">Send Link</button>
              </div>
           </form>
        )}
        ...
        {view === '2fa' && (
           <form onSubmit={handle2FASubmit} className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              <div className="group space-y-2">
                  <label htmlFor="2fa-code" className="text-xs font-semibold text-cyan-300/70 uppercase tracking-wider ml-1">Authentication Code</label>
                  <div className="relative">
                    ...
                    <input 
                        ...
                        required 
                        value={twoFactorCode} 
                        onChange={e => {setTwoFactorCode(e.target.value.replace(/[^0-9]/g, '')); clearFieldError('2fa');}} 
              ...
              <div className="flex gap-4 pt-2">
                  <button type="button" onClick={() => switchView('login')} className="flex-1 py-3 border border-white/10 text-white/60 rounded-xl text-xs font-bold uppercase hover:text-white">Cancel</button>
                  <button type="submit" disabled={isLoading} className="flex-[2] py-3 bg-cyan-600 text-white rounded-xl text-xs font-black italic uppercase hover:bg-cyan-500 disabled:opacity-50">Verify</button>
              </div>
           </form>
        )}
